...
# Initialize Firebase
cred = credentials.Certificate('/home/project/serviceAccountKey.json')
...
Thank you for your order! 🙏
            ...
            # Log the order
            logger.info(f"Order request: User {telegram_id} ordered {product_data['name']} from shop {shop_id}")
